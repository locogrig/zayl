            ...
            $("#dyf").datagrid({
                ...
                columns:[[
                    ...
                    formatter:function(value,row,index){
                       ...
                       return "<a class='del' data-options=\"plain:true,iconCls:'icon-remove'\" onclick=\"delYfang('"+row.id+"')\">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;" +
                           "<a class='del'  data-options=\" plain:true,iconCls:'icon-edit'\"  onClick=\"updateYF('"+row.id+"');\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
